...
- **In-App File Management:** Open files or folders directly in native OS file managers or safely move items to system trash (requires confirmation + additional background safety checks)
